...
mod <- cmdstan_model("/gpfs/data/troxellab/danniw/r/ordinal_mod_stan.stan");

#mod <- cmdstan_model("./ordinal_mod_stan.stan");
...
mvo_model <- function(iter, generated_data,mod){
  ...
  return(data.table(iter=iter,beta_0=res_m[1],beta_1=res_m[2],
                    ...
                    tau_1=res_m[7],tau_2=res_m[8],tau_3=res_m[9],
                    div=res_m[10],tree_hit=res_m[11]
  ))
}
