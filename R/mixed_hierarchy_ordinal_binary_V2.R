...
mod <- cmdstan_model("/gpfs/data/troxellab/danniw/r/mixed_ordinal_binary.stan");

#mod <- cmdstan_model("./mixed_ordinal_binary.stan");
...
mvo_model <- function(iter, generated_data,mod){
  ...
  return(data.table(iter=iter,beta_0=res_m["beta_0"],beta_1=res_m["beta_1"],
                    beta_2=res_m["beta_2"],beta_3=res_m["beta_3"],
                    sigma_beta_0=res_m["sigma_beta_0"],sigma_beta_1=res_m["sigma_beta_1"],
                    tau_1=res_m["tau_1"],tau_2=res_m["tau_2"],tau_3=res_m["tau_3"],
                    div=res_m["div"],tree_hit=res_m["tree_hit"]))
}
s_train <- function(iter, beta_0=-0.7, beta_1=0.5,beta_2=0.4, beta_3=0.2,#controls the contribution from the two sources of variation. 
                    sigma_beta_0=0.2, sigma_beta_1=0.1,basestudy= c(.31, .29, .20, .20),
                    n_train = 400,mod){
...
res <- rbindlist(res)
save(res, file = "/gpfs/data/troxellab/danniw/data/mixed_ordinal_binary_v3.rda")
