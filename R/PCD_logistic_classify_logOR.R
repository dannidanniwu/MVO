...
bayes_result <- rbindlist(lapply(1:3, function(x) bayes_single_rep(x,
...
res <- rbindlist(res)
save(res, file = "/gpfs/data/troxellab/danniw/data/logistic_stratify_ydiff0.rda")
...
#   geom_boxplot()+
#   labs(title="PCD difference based on simultions with low div (no individual beta's layer, outcome specific tau)",
#        y = "PCD difference")
# # 
...
#   labs(fill= "Criteria")+
#   scale_x_discrete(name="difference in potential outcomes",
#                    breaks=c("-1","1","2","3"),
# labels = c("y_trt1=0, y_trt0=1","y_trt1=1, y_trt0=0",
#            "y_trt1=y_trt0=1","y_trt1=y_trt0=0"
#            ))+ theme(strip.text.x = element_blank())+labs(fill="CLASS")
